...
using Qlud.KTTTNCN.Controls;
using Qlud.KTTTNCN.Dto;
using Qlud.KTTTNCN.Extensions;
using Qlud.KTTTNCN.Localization;
using Qlud.KTTTNCN.UI;
using Qlud.KTTTNCN.UI.Assets;
using Qlud.KTTTNCN.Views;
using DependencyResolver = Qlud.KTTTNCN.Core.Dependency.DependencyResolver;

namespace Qlud.KTTTNCN.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "KTTTNCN";
