...
{
    public class SubscriptionPaymentRepository : KTTTNCNRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<KTTTNCNDbContext> dbContextProvider)
