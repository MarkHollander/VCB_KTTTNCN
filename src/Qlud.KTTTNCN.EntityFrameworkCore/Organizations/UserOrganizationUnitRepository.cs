...
namespace Qlud.KTTTNCN.Organizations
{
    public class UserOrganizationUnitRepository : KTTTNCNRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<KTTTNCNDbContext> dbContextProvider)
