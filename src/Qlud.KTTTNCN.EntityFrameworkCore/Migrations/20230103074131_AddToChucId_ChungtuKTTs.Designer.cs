...
namespace Qlud.KTTTNCN.Migrations
{
    ...
    [Migration("20230103074131_AddToChucId_ChungtuKTTs")]
    partial class AddToChucId_ChungtuKTTs
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Qlud.KTTTNCN.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Qlud.KTTTNCN.Authorization.Users.RecentPassword", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Qlud.KTTTNCN.ChungTuKTTs.ChungTuKTT", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("BaoHiemBatBuoc")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<decimal>("KhoanDongGop")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("KhoanThuNhap")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("SoThuNhapDuocNhan")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("SoThueTNCNDaKhauTru")
                        .HasColumnType("decimal(18,2)");

                    b.Property<string>("ThoiDiemTraThuNhapNam")
                        .IsRequired()
                        .HasMaxLength(4)
                        .HasColumnType("nvarchar(4)");

                    b.Property<string>("ThoiDiemTraThuNhapThang")
                        .IsRequired()
                        .HasMaxLength(2)
                        .HasColumnType("nvarchar(2)");
                    ...
                    b.Property<decimal>("TongThuNhapChiuThue")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("TongThuNhapTinhThue")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Qlud.KTTTNCN.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Qlud.KTTTNCN.ToChucTraThuNhaps.ToChucTraThuNhap", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Qlud.KTTTNCN.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Qlud.KTTTNCN.Authorization.Users.User", null)
                        .WithMany("Claims")
