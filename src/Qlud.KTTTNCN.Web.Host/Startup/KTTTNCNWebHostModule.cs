...
using Qlud.KTTTNCN.Web.Startup.ExternalLoginInfoProviders;
...
namespace Qlud.KTTTNCN.Web.Startup
{
    ...
    public class KTTTNCNWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public KTTTNCNWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(KTTTNCNWebHostModule).GetAssembly());
        }
