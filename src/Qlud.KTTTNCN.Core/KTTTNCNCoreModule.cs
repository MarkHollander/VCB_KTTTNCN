...
using Qlud.KTTTNCN.Authorization.Ldap;
...
using Qlud.KTTTNCN.DashboardCustomization.Definitions;
using Qlud.KTTTNCN.Debugging;
using Qlud.KTTTNCN.DynamicEntityProperties;
using Qlud.KTTTNCN.Features;
using Qlud.KTTTNCN.Friendships;
using Qlud.KTTTNCN.Friendships.Cache;
using Qlud.KTTTNCN.Localization;
using Qlud.KTTTNCN.MultiTenancy;
using Qlud.KTTTNCN.Net.Emailing;
using Qlud.KTTTNCN.Notifications;
using Qlud.KTTTNCN.WebHooks;
using Newtonsoft.Json;

namespace Qlud.KTTTNCN
{
    [DependsOn(
        typeof(KTTTNCNCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class KTTTNCNCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            KTTTNCNLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = KTTTNCNConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, KTTTNCNMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<KTTTNCNSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(KTTTNCNCoreModule).GetAssembly());
        }
