...
{
    public class KTTTNCNMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
    {
        private readonly ILocalizationManager _localizationManager;
        private readonly IEmailSettingsChecker _emailSettingsChecker;
        
        public KTTTNCNMailKitSmtpBuilder(
        ...
        {
            return _localizationManager.GetString(KTTTNCNConsts.LocalizationSourceName, name);
        }
    }
}