...
using Qlud.KTTTNCN.UiCustomization;
...
{
    public class SessionAppService : KTTTNCNAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = KTTTNCNConsts.Currency,
                        CurrencySign = KTTTNCNConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = KTTTNCNConsts.AllowTenantsToChangeEmailSettings,
