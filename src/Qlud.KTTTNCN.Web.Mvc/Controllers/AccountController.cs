...
using Qlud.KTTTNCN.Authorization.Accounts;
using Qlud.KTTTNCN.Authorization.Accounts.Dto;
using Qlud.KTTTNCN.Authorization.Delegation;
using Qlud.KTTTNCN.Authorization.Impersonation;
...
using Qlud.KTTTNCN.Net.Sms;
using Qlud.KTTTNCN.Notifications;
using Qlud.KTTTNCN.Web.Models.Account;
using Qlud.KTTTNCN.Security;
using Qlud.KTTTNCN.Security.Recaptcha;
using Qlud.KTTTNCN.Sessions;
using Qlud.KTTTNCN.Url;
using Qlud.KTTTNCN.Web.Authentication.External;
using Qlud.KTTTNCN.Web.Security.Recaptcha;
using Qlud.KTTTNCN.Web.Session;
using Qlud.KTTTNCN.Web.Views.Shared.Components.TenantChange;
...
{
    public class AccountController : KTTTNCNControllerBase
    {
            ...
            string returnUrlHash = "", string ss = "")
        {
            ...
            if (loginResult.User.ShouldChangePasswordOnNextLogin)
            {
                ...
                var expireDate = Uri.EscapeDataString(Clock.Now.AddHours(1).ToString(KTTTNCNConsts.DateTimeOffsetFormat));
