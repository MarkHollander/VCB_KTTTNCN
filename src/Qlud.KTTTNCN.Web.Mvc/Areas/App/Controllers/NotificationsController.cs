...
using Qlud.KTTTNCN.Organizations;
using Qlud.KTTTNCN.Web.Areas.App.Models.Notifications;
using Qlud.KTTTNCN.Web.Areas.App.Models.OrganizationUnits;
...
namespace Qlud.KTTTNCN.Web.Areas.App.Controllers
{
    [Area("App")]
    [AbpMvcAuthorize]
    public class NotificationsController : KTTTNCNControllerBase
    {
