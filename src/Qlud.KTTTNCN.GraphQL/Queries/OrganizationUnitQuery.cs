...
using Qlud.KTTTNCN.Core.Base;
using Qlud.KTTTNCN.Core.Extensions;
using Qlud.KTTTNCN.Dto;
using Qlud.KTTTNCN.Types;

namespace Qlud.KTTTNCN.Queries
{
    public class OrganizationUnitQuery : KTTTNCNQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
