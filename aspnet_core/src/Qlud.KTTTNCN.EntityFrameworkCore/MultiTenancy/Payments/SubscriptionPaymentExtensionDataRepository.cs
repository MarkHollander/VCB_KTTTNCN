...
{
    public class SubscriptionPaymentExtensionDataRepository : KTTTNCNRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<KTTTNCNDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
