...
/// </summary>
public static class KTTTNCNJwtBearerExtensions
{
    /// <summary>
    ...
    public static AuthenticationBuilder AddAbpAsyncJwtBearer(this AuthenticationBuilder builder, string authenticationScheme, string? displayName, Action<AsyncJwtBearerOptions> configureOptions)
    {
        ...
        return builder.AddScheme<AsyncJwtBearerOptions, KTTTNCNAsyncJwtBearerHandler>(authenticationScheme, displayName, configureOptions);
    }
}
