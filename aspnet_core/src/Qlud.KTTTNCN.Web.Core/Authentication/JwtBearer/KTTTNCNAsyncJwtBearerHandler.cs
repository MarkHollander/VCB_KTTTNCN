...
{
    public class KTTTNCNAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public KTTTNCNAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
