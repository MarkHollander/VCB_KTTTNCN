...
namespace Qlud.KTTTNCN.Web.Public.Startup
{
    [DependsOn(
        typeof(KTTTNCNWebCoreModule)
    )]
    public class KTTTNCNWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public KTTTNCNWebFrontEndModule(IWebHostEnvironment env, KTTTNCNEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(KTTTNCNWebFrontEndModule).GetAssembly());
        }
    }
}
