...
using Qlud.KTTTNCN.Web.Public.Startup;
using Qlud.KTTTNCN.Web.Session;

namespace Qlud.KTTTNCN.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : KTTTNCNViewComponent
    {
