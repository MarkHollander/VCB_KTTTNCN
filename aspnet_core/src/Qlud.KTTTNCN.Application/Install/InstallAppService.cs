...
using Qlud.KTTTNCN.Migrations.Seed.Host;
...
namespace Qlud.KTTTNCN.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : KTTTNCNAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<KTTTNCNDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{KTTTNCNConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{KTTTNCNConsts.ConnectionStringName}", constring);
        }
