...
using Qlud.KTTTNCN.DynamicEntityPropertyValues.Dto;
...
namespace Qlud.KTTTNCN.DynamicEntityProperties
{
    ...
    public class DynamicEntityPropertyValueAppService : KTTTNCNAppServiceBase, IDynamicEntityPropertyValueAppService
    {
