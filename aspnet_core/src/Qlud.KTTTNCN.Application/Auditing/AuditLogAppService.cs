...
using Qlud.KTTTNCN.Auditing.Exporting;
...
using EntityHistoryHelper = Qlud.KTTTNCN.EntityHistory.EntityHistoryHelper;

namespace Qlud.KTTTNCN.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : KTTTNCNAppServiceBase, IAuditLogAppService
    {
