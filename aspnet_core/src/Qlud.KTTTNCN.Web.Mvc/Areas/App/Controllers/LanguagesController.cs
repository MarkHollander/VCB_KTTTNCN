...
using Qlud.KTTTNCN.Web.Areas.App.Models.Languages;
...
namespace Qlud.KTTTNCN.Web.Areas.App.Controllers
{
    ...
    public class LanguagesController : KTTTNCNControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = KTTTNCNConsts.LocalizationSourceName;
            }
