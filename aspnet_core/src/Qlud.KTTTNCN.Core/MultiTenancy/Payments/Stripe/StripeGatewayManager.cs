...
namespace Qlud.KTTTNCN.MultiTenancy.Payments.Stripe
{
    public class StripeGatewayManager : KTTTNCNServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "KTTTNCN";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + KTTTNCNConsts.Currency;
        }
